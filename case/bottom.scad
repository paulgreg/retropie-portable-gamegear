...
union() {
    ...
    // screen support
    color("white") support4(screenX + 8, screenY + 8, screenExtW - 12, screenExtH - 10, 2, Z - 5);

    // Pi support
    color("green") support4(screenX + 40, screenY + 22, 64, 55, 3, 8);
    ...
    if (DEBUG) {
        ...
        color("red") translate([screenX + 36.5, screenY + 18.5, 8]) import("pi-aplus.stl");
